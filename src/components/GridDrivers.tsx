import TyreIcon from "./driver/TyreIcon";
import SegmentsSectors from "./driver/SegmentsSectors";
import PositionChange from "./driver/PositionChange";
import PositionDriver from "./driver/DriverPosition";
import CarSpeed from "./driver/CarSpeed";
import CarDrs from "./driver/CarDrs";
import Gap from "./driver/Gap";
import LapTime from "./driver/LapTime";
...
const GridDrivers: React.FC = () => {
    ...
    if (!orderedDrivers) {
        return (
            <section className="styleCard w-full h-full p-3 gap-6">
    ...
    return (
        <div className="styleCard w-full mx-auto col-span-12 lg:col-span-8 block overflow-auto overflow-y-hidden">
                    ...
                    {orderedDrivers.map((driver, index) => (
                        ...
                        >
                            <td className="px-5">
                                <PositionDriver
                                    position={
                                        timingData?.Lines?.[driver.RacingNumber]
                                            ?.Position
                                    }
                                    color={
                                        drivers?.[driver.RacingNumber]
                                            ?.TeamColour || "NA"
                                    }
                                    teamName={
                                        drivers?.[driver.RacingNumber]
                                    ...
                                    acronym={
                                        drivers?.[driver.RacingNumber]?.Tla ||
                                        "NA"
                                    }
                                />
                            </td>
